...
const IncomePlans = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 text-white py-16 px-4 mt-16 sm:px-6 lg:px-8">
          ...
          {activeTab === 'trade' && (
            <div className="animate-fadeIn">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
                {[
                  { percentage: '0.5%', range: '20–500 $' },
                  { percentage: '1%', range: '500–1,000 $' },
                  { percentage: '1.5%', range: '1,000–2,000 $' },
                  { percentage: '2%', range: '2,000–5,000 $' },
                  { percentage: '2.5%', range: '5,000–10,000 $' },
                  { percentage: '3%', range: '10,000–50,000 $' }
                ].map((item, index) => (
