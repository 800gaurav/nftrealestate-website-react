...
console.log(captcha)
  ...
  return (
    <div
  className="w-full max-w-md bg-sky-50 border-[3px] border-sky-300 rounded-3xl p-5 shadow-[4px_4px_0_0_#7dd3fc] flex flex-col gap-4"
>
  <input
    type="text"
  ...
  <div
    className="flex items-center justify-between gap-3 text-2xl font-mono bg-gradient-to-br from-sky-100 via-white to-violet-100 px-4 py-3 rounded-2xl border-4 border-dashed border-sky-400 shadow-inner relative overflow-hidden"
    style={{
